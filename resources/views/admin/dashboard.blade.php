          ...
          <div class="col-lg-8 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h2 class="card-title text-primary">Hai <span class="fw-bold">{{ auth()->user()->nama}}</span></h2>
                    <h3 class="mb-4">
                      Anda Berhasil Login di SIPS sebagai <span class="fw-bold">{{ auth()->user()->level}}</span>
                    </h3>
                  </div>
                </div>
